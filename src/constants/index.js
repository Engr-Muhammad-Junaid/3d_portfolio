import {
  ...
  import gai from '../assets/tech/GAI.png';
  ...
  const services = [
    ...
    {
      title: "Conversational solutions",
      icon:  cs,
    },
  ...
  const projects = [
    ...
    },
    {
        ...
        description:
            "ConAno is an innovative NLP-assisted annotation tool designed to save time and resources while maintaining precision. It's tailored for tasks like sentiment analysis and aspect-based sentiment analysis, enhancing annotation efficiency and quality.",
        tags: [
            {
                name: "NLP",
                color: "blue-text-gradient",
        ...
        image: java,
        source_code_link: "https://github.com/AliHaider0343/Configurable-Data-Annotation-Tool-?tab=readme-ov-file",
    },
    {
        name: "A RAG Approach for Bulk Information Scrapping and Crawling",
        description:
            "The approach demonstrates seamless retrieval of structured results from websites relatedto recording, irrespective of the website's DOM or architecture. By leveraging SerpAPIand advanced language models, the process efficiently extracts relevant information,contributing to enhanced data retrieval and analysis capabilities.",
        tags: [
            {
                name: "SerpAPI",
                color: "blue-text-gradient",
    ...
    },
    {
        ...
        description:
            "This project revolves around creating an AI agent designed to assist healthcare providers in understanding patient needs, preferences for procedures, and creating comprehensive tentative plans. Leveraging Autogen and Crew AI/OpenAI agents along with specialized toolkits, the AI agent acts as a virtual assistant for healthcare facilitators, ensuring personalized care and streamlined coordination.",
        tags: [
            {
                name: "Autogen",
                color: "blue-text-gradient",
    ...
    },
    {
        ...
        description:
            "Conversational Intelligence for Conversation Processing and Classification This project aims to develop a robust system for processing and classifying conversations based on their nature and content. Specifically designed for Business Process Outsourcing (BPO) environments, the system analyzes the behaviors of agents during customer and sales support interactions. By leveraging conversational intelligence techniques, the system evaluates various metrics to track and assess agent performance accuratelyThis project revolves around creating an AI agent designed to assist healthcare providers in understanding patient needs, preferences for procedures, and creating comprehensive tentative plans. Leveraging Autogen and Crew AI/OpenAI agents along with specialized toolkits, the AI agent acts as a virtual assistant for healthcare facilitators, ensuring personalized care and streamlined coordination.",
        tags: [
            {
                name: "Streamlit",
                color: "blue-text-gradient",
    ...
    },
    {
        ...
        description:
            "Many businesses encounter hurdles when hiring individual developers for chatbot creation, often facing ambiguity regarding implementation specifics. Addressing this challenge, K Chat offers acomprehensive solution designed to empower users in constructing their own knowledgebases/vector stores from XML sources tailored to their existing business needs. Our platform enablesusers to develop versatile chatbots, generate leads, analyze conversations, and much more.Our Solution Features and Functionality",
        ...
        image: saas,
        source_link: "https://kchat.website/auth/signin",
    },
    {
        name: "Physician Appointment and Patient Records Management System",
        description: "I've developed a Physical Record Management System catering to healthcare professionals' needs. This system facilitates appointment scheduling, evaluation comments, account management, statistical reports, and boasts an intuitive Java Swing-based interface, along with Jasper Reports for report generation, all powered by an SQL backend.",
...
const certificates=[
  ...
  },
  {
    ...
    title: "Machine Learning with Python (Free Code Camp)",
    link: "https://www.freecodecamp.org/certification/fcc75f6580b-b22d-4f3c-8e95-d0fb827bdf50/machine-learning-with-python-v7",
  },
  ...
  
  {
    ...
    link: "https://www.kaggle.com/learn/certification/ali1510/intro-to-machine-learning",
  },
